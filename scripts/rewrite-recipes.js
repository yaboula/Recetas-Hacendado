...
const fileContent = `// Seed de recetas con ingredientes mapeados a productos Hacendado reales
...
fs.writeFileSync(path.join(__dirname, 'src', 'database', 'seeds', '02_recetas.seed.js'), fileContent, 'utf8');
console.log('Replaced 02_recetas.seed.js with the new 15 recipes.');
